<?php
        echo form_open_multipart('walkadmin/destination/creer');
?>
<?php
if (isset($error)) {
                    ...
                    <div class="panel-body">
                        <form role="form">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="ville" name="ville" type="text" value="">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="coordonnées" name="coordonnees" type="text" value="">
                                </div>
                                <div class="form-group">
