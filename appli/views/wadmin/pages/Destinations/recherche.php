    ...
    <div class="container-fluid">
        ...
        <div class="main-content destinations">
                ...
                <div class="col-md-12">
                    <div class="module__tools">
                        <div class="custom-search">
                            <?php echo form_open('walkadmin/destinations/recherche') ?>
            ...
            <?php  } } else { ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <p class="no-entry">Il n'y a aucune destination correspondant à votre recherche :</p>
                        <blockquote><?php echo $search ?></blockquote>
                    </div>
                </div>
