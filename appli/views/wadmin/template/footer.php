...
<!-- Vendors -->
<script type="text/javascript" src="<?php echo js_url('vendors/walkadmin/bootstrap.min'); ?>"></script>
...
<script type="text/javascript" src="<?php echo js_url('vendors/metisMenu.min'); ?>"></script>

<!-- Site's script -->
<script type="text/javascript" src="<?php echo js_url('scripts'); ?>"></script>
<script type="text/javascript" src="<?php echo js_url('walkadmin'); ?>"></script>
