...
function recoverPasswordUser($mdp,$user){
                            ...
                            <tr>
                                <td class="wrapper last">
                                    ...
                                    <table class="twelve columns">
                                        <tr>
                                            <td class="twelve sub-columns">
                                                <p class="lead">Bonjour '.ucfirst(mb_strtolower($user->prenom)).' '.ucfirst(mb_strtolower($user->nom)).'</p>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <td class="wrapper last">
                                    ...
                                    <table class="twelve columns">
                                        ...
                                        <tr>
                                            <td class="twelve sub-columns">
                                                <p>Vous avez demandé une réinitialisation de votre mot de passe pour accèder à votre espace voyageur Walkabout.</p>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <td class="wrapper last">
                                    ...
                                    <table class="twelve columns">
                                        <tr>
                                            <td class="twelve columns">
                                                <ul>
                                                    <li>Votre e-mail de connexion : '.$user->mail.'</li>
                                                    <li>Votre nouveau mot de passe : '.$mdp.'</li>
                                                </ul>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <td class="wrapper last">
                                    ...
                                    <table class="twelve columns">
                                        ...
                                        <tr>
                                            <td class="twelve sub-columns">
                                                <p class="small"><i><u><strong>Remarque :</strong></u>&nbsp;vous pourrez changer votre mot de passe une fois que vous serez parvenus à vous reconnecter à votre espace dans la catégorie "Mes informations".</i></p>
                                            </td>
                                        </tr>
                                    </table>
    ...
    <head>
        ...
        **********************************************/
        ...
        <style>
            @font-face {
                font-family: "dosis";
                src: url("'.fonts_url('Dosis/Dosis-Regular').'");
                font-weight: normal;
                font-style: normal
            }
            ...
            @font-face {
                font-family: "open-sans";
                src: url("'.fonts_url('Open_Sans/OpenSans-Regular').'");
                font-weight: normal;
                font-style: normal
            }
                            ...
                            <tr>
                                <td class="wrapper last">
                                    ...
                                    <table class="twelve columns">
                                        ...
                                        <tr>
                                            <td class="twelve columns">
                                                <h1 class="center">Récupération de mot de passe</h1>
                                                <h2 class="center">Administrateur</h2>
                                            </td>
                                        </tr>
                        ...
                        <table class="container">
                            <tr>
                                <td class="wrapper last">
                                    ...
                                    <table class="twelve columns">
                                        <tr>
                                            <td class="twelve sub-columns">
                                                <p class="lead">Bonjour '.ucfirst(mb_strtolower($admin->prenom)).' '.ucfirst(mb_strtolower($admin->nom)).',</p>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <td class="wrapper last">
                                    ...
                                    <table class="twelve columns">
                                        <tr>
                                            <td class="twelve sub-columns">
                                                <p>Votre mot de passe pour vous connecter à l\'administration du site Walkabout a été réinitialisé&nbsp;:</p>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <td class="wrapper last">
                                    ...
                                    <table class="twelve columns">
                                        <tr>
                                            <td class="twelve sub-columns">
                                                <p>Vos informations de connexion ont donc été mis à jour&nbsp;:</p>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <td class="wrapper last">
                                    ...
                                    <table class="twelve columns">
                                        <tr>
                                            <td class="twelve columns">
                                                <ul>
                                                    <li>Identifiant : '.$admin->identifiant.'</li>
                            ...
                            <tr>
                                <td class="wrapper last">
                                    ...
                                    <table class="twelve columns">
                                        <tr>
                                            <td class="twelve columns">
                                                <p>Sachez qu\'il vous est toujours possible de vous connecter soit par votre pseudo ou encore avec votre adresse email.</p>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <td class="wrapper last">
                                    ...
                                    <table class="twelve columns">
                                        <tr>
                                            <td class="twelve columns center" align="center">
                                                <p>Cordialement, l\'équipe Walkabout</p>
                                            </td>
                                        </tr>
                                    </table>
