                                    ...
                                    <table class="twelve columns">
                                        ...
                                        <tr>
                                            <td class="twelve columns">
                                                <h1 class="center">Désactivation de votre article '.$donnee->article.'</h1>
                                            </td>
                                        </tr>
                                    ...
                                    <table class="twelve columns">
                                        ...
                                        <tr>
                                            <td class="twelve sub-columns">
                                                ...
                                                <p class="lead">Nous vous informons qu\'un article du carnet '.$donnee->titre.'à été désactivé.</p>
                                                <p class="lead">L\'article concerné est l\'article intitulé : '.$donnee->article.'.</p>
                                                <p class="lead">Cet article à été désactivé car il ne respecte pas les conditions générales. Vous pouvez dès a présent régler le problème et resoumettre votre article à notre équipe de modération</p>
                                                <p class="lead"></p>
