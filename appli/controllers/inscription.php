                                    ...
                                    <table class="twelve columns">
                                        ...
                                        <tr>
                                            <td class="twelve sub-columns">
                                                <p><span class="lead">Bienvenue chez Walkabout '.$data['prenom'].'!</p>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <td class="wrapper last">
                                    ...
                                    <table class="twelve columns">
                                        <tr>
                                            <td class="twelve columns">
                                                <p>Afin d\'activer votre compte et poursuivre votre navigation sur notre site, veuillez suivre le lien suivant :<br/><br/><a href="http://walkabout-voyages.fr/confirmation/compte/'.$data['mail'].'/'.$data['num_activation'].'" target="_blank"> Activation du compte Walkabout! </a><br/><br/>Si le lien ne fonctionne pas veuillez copier/coller le lien ci dessous dans la barre d\'url de votre navigateur :<br/><br/>http://walkabout-voyages.fr/confirmation/compte/'.$data['mail'].'/'.$data['num_activation'].'</p>
                                            </td>
                                        </tr>
                                    </table>
