...
this.MediumInsert = this.MediumInsert || {}, this.MediumInsert.Templates = this.MediumInsert.Templates || {}, this.MediumInsert.Templates["src/js/templates/core-buttons.hbs"] = Handlebars.template({
        1: function(a, b, c, d) {
            var e, f, g = this.lambda,
                h = this.escapeExpression,
                i = "function",
                j = b.helperMissing,
                k = '            <li><a data-addon="' + h(g(d && d.key, a)) + '" data-action="add" class="medium-insert-action">';
            return f = null != (f = b.label || (null != a ? a.label : a)) ? f : j, e = typeof f === i ? f.call(a, {
                name: "label",
                hash: {},
                data: d
            }) : f, null != e && (k += e), k + "</a></li>\n"
        ...
        main: function(a, b, c, d) {
            var e, f = '<div class="medium-insert-buttons" contenteditable="false" style="display: none">\n    <a class="medium-insert-buttons-show"><i class="fa fa-plus"></i></a>\n    <ul class="medium-insert-buttons-addons" style="display: none">\n';
            return e = b.each.call(a, null != a ? a.addons : a, {
                name: "each",
                hash: {},
                fn: this.program(1, d),
                inverse: this.noop,
        ...
        main: function(a, b, c, d) {
            var e, f = "function",
                g = b.helperMissing,
                h = this.escapeExpression;
            return '<figcaption contenteditable="true" class="medium-insert-caption-placeholder" data-placeholder="' + h((e = null != (e = b.placeholder || (null != a ? a.placeholder : a)) ? e : g, typeof e === f ? e.call(a, {
                name: "placeholder",
                hash: {},
                data: d
            }) : e)) + '"></figcaption>'
        ...
        1: function(a, b, c, d) {
            ...
            return e = b.each.call(a, null != a ? a.styles : a, {
                name: "each",
                hash: {},
                fn: this.program(2, d),
                inverse: this.noop,
        ...
        2: function(a, b, c, d) {
            var e, f = "";
            return e = b["if"].call(a, null != a ? a.label : a, {
                name: "if",
                hash: {},
                fn: this.program(3, d),
                inverse: this.noop,
        ...
        3: function(a, b, c, d) {
            var e, f, g = this.lambda,
                ...
                i = "function",
                j = b.helperMissing,
                k = '                    <li>\n                        <button class="medium-editor-action" data-action="' + h(g(d && d.key, a)) + '">';
            return f = null != (f = b.label || (null != a ? a.label : a)) ? f : j, e = typeof f === i ? f.call(a, {
                name: "label",
                hash: {},
                data: d
            }) : f, null != e && (k += e), k + "</button>\n                    </li>\n"
        },
        5: function(a, b, c, d) {
            var e, f = '    <div class="medium-insert-embeds-toolbar2 medium-editor-toolbar medium-editor-toolbar-active">\n        <ul class="medium-editor-toolbar-actions clearfix">\n';
            return e = b.each.call(a, null != a ? a.actions : a, {
                name: "each",
                hash: {},
                fn: this.program(2, d),
                inverse: this.noop,
        ...
        main: function(a, b, c, d) {
            var e, f = "";
            return e = b["if"].call(a, null != a ? a.styles : a, {
                name: "if",
                hash: {},
                fn: this.program(1, d),
                inverse: this.noop,
                data: d
            }), null != e && (f += e), f += "\n", e = b["if"].call(a, null != a ? a.actions : a, {
                name: "if",
                hash: {},
                fn: this.program(5, d),
                inverse: this.noop,
        ...
        main: function(a, b, c, d) {
            var e, f, g = "function",
                h = b.helperMissing,
                i = '<div class="medium-insert-embeds" contenteditable="false">\n   <figure>\n      <div class="medium-insert-embed">\n         ';
            return f = null != (f = b.html || (null != a ? a.html : a)) ? f : h, e = typeof f === g ? f.call(a, {
                name: "html",
                hash: {},
                data: d
        ...
        main: function(a, b, c, d) {
            var e, f, g = "function",
                ...
                j = '<figure contenteditable="false">\n    <img src="' + i((f = null != (f = b.img || (null != a ? a.img : a)) ? f : h, typeof f === g ? f.call(a, {
                    name: "img",
                    hash: {},
                    data: d
                }) : f)) + '" alt="">\n';
            return e = b["if"].call(a, null != a ? a.progress : a, {
                name: "if",
                hash: {},
                fn: this.program(1, d),
                inverse: this.noop,
    ...
    function(a, b, c, d) {
        ...
        f.prototype.init = function() {
            ...
            return a.each(b, function(c) {
                ...
                d.find(".medium-insert-buttons").remove(), b[c].value = d.html()
            }), b
        ...
        }, f.prototype.editorUpdatePlaceholder = function(b) {
            var c, d = a(b).clone();
            d.find(".medium-insert-buttons").remove(), c = d.html().replace(/^\s+|\s+$/g, "").replace(/^<p( class="medium-insert-active")?><br><\/p>$/, ""), b.querySelector("img, blockquote") || "" !== c ? this.hidePlaceholder(b) : (this.showPlaceholder(b), this.base._hideInsertButtons(a(b)))
            ...
            var b, c, d, e = this;
            this.options.enabled !== !1 && (("" === this.$el.html().trim() || "<br>" === this.$el.html().trim()) && this.$el.html(this.templates["src/js/templates/core-empty-line.hbs"]().trim()), d = this.$el.contents().filter(function() {
                return "#text" === this.nodeName && "" !== a.trim(a(this).text())
            }), d.each(function() {
            ...
            return this.each(function() {
                a.data(this, "plugin_" + g) ? "string" == typeof b && a.data(this, "plugin_" + g)[b] && a.data(this, "plugin_" + g)[b]() : (a.data(this, "plugin_" + g, new f(this, b)), a.data(this, "plugin_" + g).init())
            })
        }
    ...
    function(a, b, c, d) {
        ...
        e.prototype.init = function() {
            ...
            a.support.cors = !0, a.ajax({
                ...
                success: function(b) {
                    var c = b && b.html;
                    b && !b.html && "photo" === b.type && b.url && (c = '<img src="' + b.url + '" alt="">'), a.proxy(d, "embed", c)()
                },
            ...
            return a ? (b.after(this.templates["src/js/templates/embeds-wrapper.hbs"]({
                html: a
            })), b.remove(), this.$el.trigger("input"), -1 !== a.indexOf("facebook") && "undefined" != typeof FB && setTimeout(function() {
                FB.XFBML.parse()
            ...
            c = this.$el.find(".medium-insert-embeds-active"), e = a(f), c.before(e), c.remove(), e.html(b), d = a(f), e.after(d), this.$el.trigger("input"), this.core.moveCaret(c)
            ...
            var b, c, d, e = this.$el.find(".medium-insert-embeds-selected"),
                f = !1;
            0 !== e.length && (a("body").append(this.templates["src/js/templates/embeds-toolbar.hbs"]({
            ...
            d && d(this.$el.find(".medium-insert-embeds-selected")), this.$el.trigger("input")
        }, a.fn[f + g] = function(b) {
            return this.each(function() {
    ...
    function(a, b, c, d, e) {
        ...
        f.prototype.init = function() {
            ...
            var d = a.proxy(this, "showImage", c.result.files[0].url, c)();
            $('.medium-insert-active figure img').attr('src',base_url+c.result.files[0].url);
            $('.medium-insert-active').removeClass('medium-insert-active');            
            this.core.clean(), this.sorting(), this.options.uploadCompleted && this.options.uploadCompleted(d, c)
            ...
            return f.click(), e = this, this.options.preview && c.context ? (d = this.getDOMImage(), d.onload = function() {
                c.context.find("img").attr("src", d.src), e.$el.trigger("input")
            }, d.src = b) : (c.context = a(this.templates["src/js/templates/images-image.hbs"]({
                img: b,
            ...
            }), f.addClass("medium-insert-images-grid"), this.options.styles.grid.added && this.options.styles.grid.added(f)), this.options.preview && c.submit()), this.$el.trigger("input"), c.context
            ...
            if (this.core.options.enabled) {
                var c = a(b.target),
                    d = this;
                this.$el.blur(), c.addClass("medium-insert-image-active"), c.closest(".medium-insert-images").addClass("medium-insert-active"), setTimeout(function() {
            ...
            return c.is("img") && c.hasClass("medium-insert-image-active") ? (d.not(c).removeClass("medium-insert-image-active"), a(".medium-insert-images-toolbar, .medium-insert-images-toolbar2").remove(), void this.core.removeCaptions(c)) : (d.removeClass("medium-insert-image-active"), a(".medium-insert-images-toolbar, .medium-insert-images-toolbar2").remove(), void(c.is(".medium-insert-caption-placeholder") ? this.core.removeCaptionPlaceholder(d.closest("figure")) : c.is("figcaption") === !1 && this.core.removeCaptions()))
            ...
            this.options.deleteScript && a.post(this.options.deleteScript, {
                file: b
            })
            ...
            var b, c, d, e = this.$el.find(".medium-insert-image-active"),
                ...
                g = !1;
            a("body").append(this.templates["src/js/templates/images-toolbar.hbs"]({
                styles: this.options.styles,
                actions: this.options.actions
                ...
                f.hasClass("medium-insert-images-" + a(this).data("action")) && (a(this).addClass("medium-editor-button-active"),
                    g = !0)
            ...
            c.addClass("medium-editor-button-active"), d.siblings().find(".medium-editor-button-active").removeClass("medium-editor-button-active"), f.find("button").each(function() {
                ...
                a(this).hasClass("medium-editor-button-active") ? (g.addClass(b), h.options.styles[a(this).data("action")].added && h.options.styles[a(this).data("action")].added(g)) : (g.removeClass(b), h.options.styles[a(this).data("action")].removed && h.options.styles[a(this).data("action")].removed(g))
            }), this.core.hideButtons(), this.$el.trigger("input")
        }, f.prototype.toolbar2Action = function(b) {
            var c = a(b.target).is("button") ? a(b.target) : a(b.target).closest("button"),
                d = this.options.actions[c.data("action")].clicked;
            d && d(this.$el.find(".medium-insert-image-active")), this.core.hideButtons(), this.$el.trigger("input")
